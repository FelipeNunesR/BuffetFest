...
let testemonials = [
    {quote:'"Simplesmente incrível! O atendimento  '+
     'foi impecável e a comida maravilhosa."', origin:'cbs.svg' }, 
    {quote:'"A equipe do buffet foi super '+ 
        'atenciosa e se preocupou com cada detalhe. '+
        'Desde a decoração até a apresentação dos pratos."',
        origin:'forbes.svg' }, 
    {quote:'"Fiquei impressionada com a qualidade do serviço. '+ 
        'A comida estava deliciosa, e a apresentação de cada prato era impecável."', origin:'fox.svg' }, 
    {quote:'"Tivemos uma experiência maravilhosa com esse buffet! "',
...
//FAQ
//Varíavel para controlar o item faq atual
let currentFaq = 0;
...
const setFaq = (index) =>{
    currentFaq = index;
    //se o item atual já esitver aberto, fecha e retorna
